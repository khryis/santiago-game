...
public class PositionSegment extends Position {
	 ...
	 * @param segment2
	 */
	public static void determineAdjacentAPosition(Position position,
			PositionSegment segment1, PositionSegment segment2) {

		int x = position.getX(), y = position.getY(), x2 = position.getX(), y2 = position
				.getY();
